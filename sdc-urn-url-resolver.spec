...
%description
Nagios probe for a urn url resolver.
...
install -m 755 urn_url_resolver.sh %{buildroot}/%{_libexecdir}/argo-monitoring/probes/seadatacloud-nvs2/urn_url_resolver.sh
...
%attr(0755,root,root) /%{_libexecdir}/argo-monitoring/probes/seadatacloud-nvs2/urn_url_resolver.sh
